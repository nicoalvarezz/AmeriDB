...
- [x] Implement pin(BlockId)
- [x] Implement unpin(BlockId)
- [x] Implement replacement algorithm (Clock recommended)
- [x] Implement eviction with dirty-page flush
- [x] Maintain page table (PageId → Frame)
